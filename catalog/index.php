...
if(($this_url == '/catalog/') || (strpos($this_url, 'catalog/?') != false))
{
	header('Location: /catalog/steklo-bectsvetnoe/');
}
/*редирект*/
?>
...
<script type="text/javascript" src="<?= SITE_TEMPLATE_PATH.'/libraries/jquery-3.6.0.js'; ?>"></script>
